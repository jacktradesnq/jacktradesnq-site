...
.jtnq-tl .wordmark{
  ...
  font-size: clamp(50px, 8.8vw, 132px); line-height: .92; letter-spacing: -0.028em; margin: 0; color: var(--c-text);
}
...
.jtnq-tl .plans-link svg{ width: 13px; height: 13px; }
.jtnq-tl .plans-link:hover{ color: var(--c-accent); gap: 13px; }
